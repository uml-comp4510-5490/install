...
if("FALSE" STREQUAL "TRUE")
  set(pr2_machine_SOURCE_PREFIX /home/cs/robot_sim/manip_ws/src/pr2_common/pr2_machine)
  set(pr2_machine_DEVEL_PREFIX /home/cs/robot_sim/manip_ws/devel)
  ...
  set(pr2_machine_INSTALL_PREFIX /home/cs/robot_sim/manip_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/pr2_machine " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/pr2_machine' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pr2_machine' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pr2_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cs/robot_sim/manip_ws/install/${idir}'.  ${_report}")
    endif()
