...
if("FALSE" STREQUAL "TRUE")
  set(sawyer_sim_controllers_SOURCE_PREFIX /home/cs/robot_sim/manip_ws/src/sawyer_simulator/sawyer_sim_controllers)
  set(sawyer_sim_controllers_DEVEL_PREFIX /home/cs/robot_sim/manip_ws/devel)
  ...
  set(sawyer_sim_controllers_INSTALL_PREFIX /home/cs/robot_sim/manip_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sawyer_sim_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cs/robot_sim/manip_ws/install/${idir}'.  ${_report}")
    endif()
