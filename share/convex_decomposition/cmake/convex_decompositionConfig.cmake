...
if("FALSE" STREQUAL "TRUE")
  set(convex_decomposition_SOURCE_PREFIX /home/cs/robot_sim/manip_ws/src/convex_decomposition)
  set(convex_decomposition_DEVEL_PREFIX /home/cs/robot_sim/manip_ws/devel)
  ...
  set(convex_decomposition_INSTALL_PREFIX /home/cs/robot_sim/manip_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  set(_include_dirs "")
  if(NOT "http://kforge.ros.org/robotmodel/Trac " STREQUAL " ")
    set(_report "Check the issue tracker 'http://kforge.ros.org/robotmodel/Trac' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://codesuppository.blogspot.com " STREQUAL " ")
    set(_report "Check the website 'http://codesuppository.blogspot.com' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Bryce Vondervoort <bvondervoort@clearpathrobotics.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'convex_decomposition' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'convex_decomposition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cs/robot_sim/manip_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${convex_decomposition_dep}_FOUND)
      find_package(${convex_decomposition_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${convex_decomposition_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
